...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'starpai':
				frames = Paths.getSparrowAtlas('weeb/starsenpai');
				animation.addByPrefix('idle', 'Starpai Idle', 24, false);
				animation.addByPrefix('singUP', 'STARPAI UP NOTE', 24, false);
				animation.addByPrefix('singLEFT', 'STARPAI LEFT NOTE', 24, false);
				animation.addByPrefix('singRIGHT', 'STARPAI RIGHT NOTE', 24, false);
				animation.addByPrefix('singDOWN', 'STARPAI DOWN NOTE', 24, false);

				addOffset('idle', -220, -280);
				addOffset('singUP', -220, -240);
				addOffset("singRIGHT", -220, -280);
				addOffset("singLEFT", -200, -280);
				addOffset("singDOWN", -200, -300);
			...
			case 'drippai':
				frames = Paths.getSparrowAtlas('weeb/starsenpai');
				animation.addByPrefix('idle', 'Angry Starpai Idle', 24, false);
				animation.addByPrefix('singUP', 'Angry Starpai UP NOTE', 24, false);
				animation.addByPrefix('singLEFT', 'Angry Starpai LEFT NOTE', 24, false);
				animation.addByPrefix('singRIGHT', 'Angry Starpai RIGHT NOTE', 24, false);
				animation.addByPrefix('singDOWN', 'Angry Starpai DOWN NOTE', 24, false);
